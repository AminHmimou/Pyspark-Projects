...
from (
    ...
    from @stage_sch.csv_stage/initial/order_item/order-Item-initial.csv t
)
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @stage_sch.csv_stage/initial/order_item/order-item-initial-v2.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @stage_sch.csv_stage/delta/order_item/day-01-order-item.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @stage_sch.csv_stage/delta/order_item/day-02-order-item.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;